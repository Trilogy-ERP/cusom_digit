...
def _generate_temporary_login_link(email: str, expiry: int):
    ...
    return get_url(f"/api/method/optima.www.login.login_via_key?key={key}")

from optima.override.doctype_class.login_manager import CustomLoginManager
...
def login_via_key(key: str):
    ...
    if email:
        frappe.local.login_manager = CustomLoginManager()
        frappe.cache().delete_value(cache_key)
        frappe.local.login_manager.login_as(email , key)
